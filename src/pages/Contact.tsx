...
import { MapPin, Phone, Mail, Clock, Send, CheckCircle2, ShieldCheck, Sun, MessageCircle } from 'lucide-react';
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">sungreen0912@naver.com</p>
                    </div>
                  </div>
          ...
          <div className="space-y-6">
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600">
                  A. 일반적으로 주택용은 1일(현장여건에 따라 상의), 상업용은 규모에 따라 1-2주 소요됩니다.
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600">
                  A. 지역과 설치 용량에 따라 차이가 있으며, 일반적으로 설치비의 30~70% 정도 지원받으실 수 있습니다.
