...
const Company = () => {
  const milestones = [{
    year: '2025',
    event: '미래성장동력 확보',
    description: '경기도 RE100 및 기회소득마을 조성사업 참여 기업 선정'
  }, {
    year: '2024',
    event: '지속적 성장',
    description: '태양광 시공 누적 2,500건 달성 및 기술혁신형 중소기업(INNO-BIZ) 인증'
  }, {
    year: '2023',
    event: '사업 확장',
    description: '정부지원사업(주택, 건물, 융복합) 확대 및 ISO 14001 환경경영시스템 인증'
  }, {
    year: '2022',
    event: '기술 우수성 인정',
    description: '벤처기업 인증 및 스마트 모니터링 시스템 도입'
  }, {
    year: '2020',
    event: '회사 설립',
  ...
  const certifications = [
    '경기도 RE100 참여기업 선정',
    '경기도 기회소득마을 조성사업 참여',
    '기술혁신형 중소기업확인서 (INNO-BIZ)',
    '벤처기업 확인서',
    'ISO 9001 품질경영시스템 인증',
    'ISO 14001 환경경영시스템 인증',
    '신재생에너지설비 AS지정 기술·전문인력 등록',
    '전기공사업 등록증',
    '건설업등록증'
  ];
  const companyStats = [{
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="space-y-6 text-lg text-slate-700 leading-relaxed">
                <p>
                  썬그린에너지는 신재생에너지 분야에서 20년 이상의 풍부한 실무 경험과
                  빅데이터 기반의 Deep Learning 솔루션을 갖춘 태양광 전문기업입니다.
                </p>
                <p>
                  경기도 RE100 및 기회소득마을 조성사업 등 정부 및 지자체 주도 사업의
                  핵심 파트너로서, 안전하고 효율적인 에너지 전환을 선도하고 있습니다.
                </p>
                <p className="font-semibold text-emerald-600">
                  부지 분석부터 설계, 인허가, 시공, AS까지 이어지는 <span className="underline">One-Stop 솔루션으로 최고의 만족을 드립니다.</span>
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center space-x-4 p-4 bg-slate-50 rounded-xl">
                ...
                <div>
                  ...
                  <div className="text-slate-700">sungreen7690@naver.com</div>
                </div>
              </div>
            </div>
          </div>
